/* =============================================
   CIAOCIAO DA' VITO — Shared Navbar
   ============================================= */
...
(function () {
  ...
  function buildNavbar() {
    ...
    navbar.innerHTML = `
      <div class="container">
        <div class="nav-inner">
          <a href="index.html" class="nav-logo" aria-label="CiaoCiao da' Vito Pizzería - Inicio">
            <span class="nav-logo-main">CiaoCiao <span>da' Vito</span></span>
